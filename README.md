...
|--------|---------|--------------|
| **[digital-marketing-pro](https://github.com/indranilbanerjee/digital-marketing-pro)** | 3.4.0 | End-to-end digital marketing engagement methodology. **v3.4.0** adds C2PA content-provenance for EU AI Act Article 50 compliance (embed-c2pa.py + c2pa-metadata skill + /check verification), unified ads-platform MCPs (Synter / Ryze / Northbeam) in the connectors catalog, explicit parallel subagent dispatch in engagement-workflow + 4 multi-dimensional commands (~6x wall-clock speedup), and an Anthropic Software Directory submission packet. v3.3 modernized May 2026 reality across privacy/compliance, channel mechanics, AEO/GEO. 12-Part Strategy Flow producing the Four Core Documents (61 explicit steps), Two-Views Model, Decision Matrix, Living Project Instruction File. 25 specialist agents, 150 skills, 71 Python scripts, 10 commands, 14 HTTP MCP connectors. |
