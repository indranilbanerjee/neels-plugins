...
|--------|---------|--------------|
| **[digital-marketing-pro](https://github.com/indranilbanerjee/digital-marketing-pro)** | 3.2.2 | End-to-end digital marketing engagement methodology. 12-Part Strategy Flow producing the Four Core Documents (61 explicit steps), Two-Views Model, Decision Matrix, Living Project Instruction File. 25 specialist agents, 149 skills, 68 Python scripts, 10 top commands, 14 HTTP MCP connectors. v3.1 removed all global hooks; v3.2 closes the hook-removal gaps with `/digital-marketing-pro:check` pre-publish gate, `/digital-marketing-pro:status` brand snapshot, embedded hallucination checks in content/email/social/PR agents. v3.2.1 fixed manifest install format. v3.2.2 swept `/dm:` shorthand to `/digital-marketing-pro:` for namespace consistency. |
