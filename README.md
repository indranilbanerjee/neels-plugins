...
| **[contentforge](https://github.com/indranilbanerjee/contentforge)** | 3.7.0 | Enterprise content production pipeline with 13 agents, 19 skills, 9 HTTP connectors, 6 evals. v3.7 adds SERP-informed title curation, pre-flight brand validation, scoring fixes, per-phase tracking, expanded brand profiles. |
