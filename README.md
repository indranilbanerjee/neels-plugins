...
[![Version](https://img.shields.io/badge/version-3.5.12-blue.svg)](CHANGELOG.md)
...
|--------|---------|--------------|
| **[digital-marketing-pro](https://github.com/indranilbanerjee/digital-marketing-pro)** | 3.4.2 | End-to-end digital marketing engagement methodology. **v3.4.2** doc bundle: Opus 4.7 1M-context guidance for single-conversation 12-part engagements; WhatsApp Business voice calling (May 2026 launch); Google PMax 2026 + Meta Advantage+ 2026 + LinkedIn Ads + TikTok USDS + retail-media updates in execution-workflows; planning doc for v3.5/v4.0 Multiagent Sessions API + Memory API beta adoption. **v3.4.1** audit pass on v3.4.0: C2PA script rewritten against real c2pa-python 0.32 API and end-to-end tested; ads MCP entries corrected (Synter Media AI 7 platforms at mcp.syntermedia.ai, Ryze AI Google-Ads managed-OAuth, Northbeam community-maintained); parallel-dispatch speedup softened to honest 4-6x parallelism with ~50-80% wall-clock reduction. **v3.4** added C2PA content-provenance for EU AI Act Article 50, unified ads-platform MCPs, parallel subagent dispatch, Anthropic Software Directory submission packet. v3.3 modernized May 2026 reality across privacy/compliance, channel mechanics, AEO/GEO. 12-Part Strategy Flow producing the Four Core Documents (61 explicit steps), Two-Views Model, Decision Matrix, Living Project Instruction File. 25 specialist agents, 150 skills, 71 Python scripts, 10 commands, 14 HTTP MCP connectors. |
